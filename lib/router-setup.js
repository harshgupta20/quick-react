...
const mainContentTanstack = (cssImports, isTS) => {
 ...
 * @param {boolean} isTS Flag for ts or js
 */
const updateViteConfig = (projectPath, isTS) => {    
 ...
 * @returns {void}
 */
const setUpTanstackRouter = (projectPath, isTS) => {
 ...
 * @returns {void}
 */
export const setupRoutingFramework = (projectPath, routingFramework, cssFramework, isTS) => {
    ...
    if(routingFramework === 'React Router') {
      ...
      setUpTanstackRouter(projectPath, isTS);
      ...
      updateViteConfig(projectPath, isTS);
    }
