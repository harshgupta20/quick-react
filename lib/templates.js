// utils.js helpers will be imported here
...
export const createZustandStore = (projectPath) => {
...
export const useAuthStore = create((set) => ({
  ...
  writeFile(path.join(storeDir, "useAuthStore.js"), zustandContent);
};
...
${
  packages.length > 0
    ? `- 📦 **Additional Packages**: ${packages.join(", ")}`
    : ""
}
